...
export class ScoreUtil {
  ...
  determineDivider(total): number {
    if (this.between(total, 0, 100)) {
      ...
      return 300;
    } else if (this.between(total, 2000, 5300)) {
      return 500;
    } else if (this.between(total, 5300, 12300)) {
      return 1000;
    } else if (this.between(total, 12300, 26300)) {
      return 2000;
    } else if (this.between(total, 26300, 47300)) {
      return 3000;
    } else if (this.between(total, 27300, 75300)) {
      return 4000;
    } else if (this.between(total, 75300, 110300)) {
      return 5000;
    } else {
      return 10000;
    }
