...
export const IMAGE_ORIGIN = 'https://mars.webebook.org/static/roo/img/';

export const AUTH_REDIRECT_URI = 'marsroo://oauth2redirect';

export const AUTH_IAB_REDIRECT_URI = 'http://localhost:8100';

export const MAIL_SUPPORT = 'webebook.org@gmail.com';
